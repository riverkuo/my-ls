import { PathReader } from './strategies/path-reader.js';
import { RegexReader } from './strategies/regex-reader.js';
import { DirectoryReader } from './strategies/directory-reader.js';
